         ...
         <form @submit.prevent="submit">
            <div class="flex justify-around">
                <div>
                    ...
                    <div class="shared">
                        <div class="inputs">
                            <label for="">max. vitesse nominale</label>
                            <input type="text" v-model="form.max_vitesse">
                        </div>
                        <div class="inputs">
                            <label for="">max_charge admissible</label>
                            <input type="text" v-model="form.max_charge">
                        </div>
                        <div class="inputs">
                            <label for="">min_charge admissible</label>
                            <input type="text" v-model="form.min_charge">
                        </div>
        ...
        data(){
            return {
                form:this.$inertia.form({
                    _method: 'put',
                    name: this.levage.name,
                    main_image:null,

                    max_vitesse:this.levage.max_vitesse,
                    max_charge:this.levage.max_charge,
                    min_charge:this.levage.min_charge,

                }),
                main_image:'/storage/'+this.levage.main_image,
            }
        },
        methods:{
            add_img_main(e){
            ...
            submit() {
                this.form.post(route('levage.update',this.levage.id),{
                    preserveScroll: true,                   
                })
            },
        }
