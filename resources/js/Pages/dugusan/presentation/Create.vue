            ...
            <CreateComponent >
                <template #en>
                    <div class="inputs" v-for="(paragraph, index) in form.paragraphes_en" :key="index">
                        ...
                        <textarea name="" id="" cols="30" rows="10" v-model="form.paragraphes_en[index].paragraph"></textarea>
                ...
                <template #fr>
                    <div class="inputs" v-for="(paragraph, index) in form.paragraphes_fr" :key="index">
                        <label for="">paragraphe n°{{ index+1 }}</label>
                        <textarea name="" id="" cols="30" rows="10" v-model="form.paragraphes_fr[index].paragraph"></textarea>
                        <div class="delete" v-if="index!=0" @click="deleteP(index)">
                            X
                        </div>
                    </div>
                ...
                <template #tr>
                    <div class="inputs" v-for="(paragraph, index) in form.paragraphes_tr" :key="index">
                        <label for="">paragraphe n°{{ index+1 }}</label>
                        <textarea name="" id="" cols="30" rows="10" v-model="form.paragraphes_tr[index].paragraph"></textarea>
                        <div class="delete" v-if="index!=0" @click="deleteP(index)">
                            X
                        </div>
                    </div>
...
import Content from '@/Pages/globalComponents/shared/Content.vue';
    ...
    Content
        ...
        methods:{
            ...
            submit() {
                this.form.post(route('presentation.store'),{
                    preserveScroll: true,                   
                })
            },
        }
